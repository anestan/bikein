...
namespace Sass {
  ...
  namespace Functions {
    ...
    Signature rgba_4_sig = "rgba($red, $green, $primary, $alpha)";
    BUILT_IN(rgba_4)
    {
      if (
        special_number(Cast<String_Constant>(env["$red"])) ||
    ...
    Signature adjust_color_sig = "adjust-color($color, $red: false, $green: false, $primary: false, $hue: false, $saturation: false, $lightness: false, $alpha: false)";
    BUILT_IN(adjust_color)
    {
      Color_Ptr color = ARG("$color", Color);
      Number_Ptr r = Cast<Number>(env["$red"]);
      Number_Ptr g = Cast<Number>(env["$green"]);
      Number_Ptr b = Cast<Number>(env["$primary"]);
      ...
      if (rgb) {
        ...
        double bb = b ? DARG_R_BYTE("$primary") : 0;
    ...
    Signature scale_color_sig = "scale-color($color, $red: false, $green: false, $primary: false, $hue: false, $saturation: false, $lightness: false, $alpha: false)";
    BUILT_IN(scale_color)
    {
      ...
      if (rgb) {
        ...
        double bscale = (b ? DARG_R_PRCT("$primary") : 0.0) / 100.0;
    ...
    Signature change_color_sig = "change-color($color, $red: false, $green: false, $primary: false, $hue: false, $saturation: false, $lightness: false, $alpha: false)";
